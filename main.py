...
while(cap.isOpened()):
    ...
    for face_landmarks, name in zip(face_landmarks_list, face_names):
        top=face_landmarks['left_eyebrow'][4][1]*4-100
        right=face_landmarks['chin'][16][0]*4+10
        bottom=face_landmarks['chin'][8][1]*4+10
        left=face_landmarks['chin'][0][0]*4-10
        if not face_flag:
            continue
