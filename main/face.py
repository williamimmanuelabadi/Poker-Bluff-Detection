...
new_width =  1280 # Lebar yang diinginkan
...
output = cv2.VideoWriter('output_face.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 30, (1000,1000))
...
while(cap.isOpened()):
    ...
    for face_landmarks in face_landmarks_list:
        ...
        bottom1=bottom
        left1=left
        draw_box(frame, left1, top1, right1, bottom1, name, card)
    print(top1, right1, bottom1, left1)
